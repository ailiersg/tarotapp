...
var BuyServicePage = /** @class */ (function () {
    ...
    BuyServicePage.prototype.generateOrder = function () {
        ...
        console.log("localUserId=" + this.appMin.getUserid());
        var obj = {
            type: 'generateOrder',
