...
module.exports = "ion-footer ion-button {\n  margin: 0px; }\n\n.six_btn {\n  --color:#666666;\n  --background:#ffffff;\n  --background-activated:#ffffff;\n  --color-activated:#666666; }\n\nion-toolbar {\n  --background:transparent;\n  --border-color:#ffffff\n; }\n\n#consultant_content .swiper-container {\n  border-bottom-left-radius: 34px 10px !important;\n  border-bottom-right-radius: 34px 10px !important;\n  border-bottom: solid 3px #e8effa; }\n\nion-header {\n  box-shadow: 0px 0px 0px 0px transparent !important; }\n\n.foll-btn {\n  --padding-start:0.5rem;\n  --padding-end:0.5rem;\n  --padding-bottom:0.1rem;\n  --padding-top:0.1rem; }\n\n.placeholder {\n  background-color: #ebebef;\n  color: #bbb;\n  text-align: center;\n  height: 30px;\n  line-height: 30px;\n  width: 100%; }\n\n.share_img_coat .title {\n  font-size: 1.2rem;\n  color: #666666; }\n\n.share_img_coat {\n  text-align: center; }\n\n.share_img {\n  width: 5rem;\n  height: 5rem; }\n\n.user_s_f {\n  width: 94%;\n  padding: 10px;\n  background: #fff;\n  border-radius: 10px;\n  box-shadow: 2px 8px 15px -8px #eee;\n  position: absolute;\n  top: 12rem;\n  z-index: 2;\n  left: 0;\n  right: 0;\n  margin: 0px auto;\n  padding-bottom: 0px; }\n\n.user_s_f ion-col {\n  padding-bottom: 1rem; }\n\n.user_s_f button {\n  font-size: 1.2rem !important;\n  padding: 0rem 0.3rem;\n  height: 1.8em;\n  margin: 0px; }\n\n.img_f {\n  z-index: 1;\n  border-radius: 50%;\n  padding-top: 2px;\n  display: inline-block; }\n\n.toux_img {\n  z-index: 999;\n  border-radius: 50%;\n  width: 4.9rem;\n  height: 4.9rem; }\n\n.toux_img_bq {\n  position: absolute;\n  background-color: #ff6dc1;\n  text-align: center;\n  width: 1.7rem;\n  height: 1.7rem;\n  line-height: 2rem;\n  border-radius: 50%;\n  right: 0rem;\n  bottom: 0rem; }\n\n.toux_img_bq ion-icon {\n  color: #FFFFFF;\n  font-size: 0.9em;\n  font-weight: 900; }\n\n.scroll-content {\n  padding-top: 0px !important; }\n\n.sex_ion {\n  font-size: 0.9em;\n  font-weight: 300; }\n\n.sex_ion2 {\n  font-size: 0.9em;\n  font-weight: 300; }\n\n.sex_bac {\n  background: #91b3d4; }\n\n.xinxitongji_span {\n  font-family: Georgia;\n  font-size: 2.35rem;\n  color: #333333; }\n\n.xinxitongji_p_f {\n  margin-top: 10px; }\n\n.xinxitongji_p {\n  margin: 0px;\n  padding: 0px;\n  margin-top: 5px;\n  text-align: center;\n  color: #666666;\n  font-size: 1.6rem; }\n\nion-header ion-icon {\n  color: #fff;\n  transition: color 0.3s;\n  transition: border 0.4s; }\n\n.header1 {\n  transition: background 0.3s; }\n\n.bq {\n  color: #fff;\n  border-radius: 20px;\n  vertical-align: middle;\n  padding: 0.3rem 0.5rem;\n  font-size: 1.1rem;\n  margin-left: 0.2rem;\n  background: #0cd1e8; }\n\npage-consultant {\n  background: #454343; }\n\n.ion-badge_f ion-badge {\n  margin-bottom: 0.2rem; }\n\n.ion-badge_f {\n  margin-top: 0.3rem;\n  height: 1.8rem;\n  overflow: hidden; }\n\n.swiper-pagination-bullet-active {\n  background: #fff; }\n\n.serviceF {\n  padding: 8px 10px;\n  border-bottom: 1px solid #eee;\n  -webkit-transform: 0.1s background;\n          transform: 0.1s background;\n  transition: 0.5s left;\n  transition: all 1s;\n  background: #fff;\n  position: relative; }\n\n.serviceF_select .col_title_l p {\n  color: #f36969;\n  transition: color 0.2s; }\n\n.serviceF:active {\n  background: whitesmoke; }\n\n.col_title_l {\n  text-align: left; }\n\n.col_title_l p {\n  color: #333333;\n  font-size: 1.55rem; }\n\n.col_title_r {\n  text-align: right; }\n\n.col_title_r p {\n  font-family: Georgia;\n  font-size: 1.7rem; }\n\n.con_col {\n  padding-bottom: 0.85rem;\n  color: #666666;\n  padding-left: 5px;\n  font-size: 1.45rem; }\n\n.money_p {\n  font-size: 1.3em;\n  font-family: Georgia;\n  color: #e71010; }\n\n.sp1 {\n  padding: 3px 5px;\n  /* border: 1px solid #eee; */\n  border-radius: 30px;\n  background: #f5c3c0;\n  color: #fff;\n  font-size: 1.2rem; }\n\n.sp2 {\n  padding: 3px 5px;\n  /* border: 1px solid #eee; */\n  border-radius: 30px;\n  background: #f9d8ac;\n  color: #fff;\n  font-size: 1.2rem;\n  margin-left: 5px; }\n\n.row_top p {\n  margin-bottom: 5px;\n  margin-top: 0px; }\n\n.name_bq {\n  padding: 1px;\n  border-radius: 1px; }\n\n.listobj_f .serviceF:nth-last-child(1) {\n  border-bottom-width: 0px; }\n\n.tiao {\n  height: 9px;\n  border-radius: 5px;\n  background: #eee; }\n\n.tiao_f {\n  width: 70%;\n  float: left;\n  margin-left: 5px;\n  margin-top: 3px; }\n\n.col_title1 {\n  font-size: 0.9em;\n  color: #666666; }\n\n.tiao_n {\n  height: 9px;\n  border-radius: 5px; }\n\n.tiao_n_count1 {\n  width: 85%; }\n\n.tiao_n_count2 {\n  width: 40%; }\n\n.tiao_n_count3 {\n  width: 100%; }\n\n.pj_item {\n  padding: 0px; }\n\n.ztpj_f {\n  padding: 5px 10px;\n  padding-bottom: 15px; }\n\n.tiao_color3 {\n  background: #b4a0e2; }\n\n.serviceF:last-child {\n  margin-bottom: 0px; }\n\n.xing_img_f {\n  padding: 10px;\n  padding-top: 25px;\n  text-align: center; }\n\n.xing_img_f img {\n  width: 1.7em;\n  margin-right: 2%; }\n\n.pf_f {\n  margin-top: 15px;\n  display: flex; }\n\n.pf_f div {\n  text-align: center;\n  flex: 1; }\n\n.pf_f div span {\n  font-size: 1.3rem; }\n\n.pf_f div span:nth-child(1) {\n  margin-right: 5px;\n  color: #333333; }\n\n.pf_f div span:nth-child(2) {\n  color: red; }\n\n.pjbq {\n  margin-top: 22px; }\n\n.pjbq_b {\n  display: inline-block;\n  padding: 2px 6px;\n  border-radius: 10px;\n  background: #edf2fd;\n  font-size: 1.25rem;\n  margin-right: 3%;\n  margin-bottom: 6%; }\n\n.pjbq_b span {\n  color: #666666; }\n\n.mybtn {\n  font-size: 1.45rem; }\n\n.pjbq_b span:nth-child(1) {\n  margin-right: 3px; }\n\n.pl_list_f {\n  margin-bottom: 100px;\n  background: #fff;\n  border-radius: 10px;\n  margin-top: 25px;\n  padding-top: 20px;\n  padding-bottom: 20px;\n  box-shadow: 0px -3px 10px #f1f1f1; }\n\n.xux_f {\n  text-align: center; }\n\n.xux_l, .xux_r {\n  display: inline-block;\n  width: 30%;\n  height: 1px;\n  margin-top: 10px;\n  margin-bottom: 4px; }\n\n.xux_l {\n  background: -webkit-linear-gradient(left, #ffffff, #c5c5c5); }\n\n.xux_r {\n  background: -webkit-linear-gradient(left, #c5c5c5, #ffffff); }\n\n.xux_txt {\n  display: inline-block;\n  padding: 0px 5px;\n  color: #333333;\n  font-size: 1.6rem;\n  margin-left: 5%;\n  margin-right: 5%;\n  text-align: center; }\n\n.pl_list_f .pl_img {\n  width: 1em; }\n\n.user_info_bottom {\n  text-align: left;\n  margin-left: 10px; }\n\n.user_info_bottom .date, .buy_server_name {\n  display: inline-block; }\n\n.user_info_bottom div {\n  font-size: 1.3rem;\n  color: #999999; }\n\n.pl_list_d {\n  padding: 15px;\n  border-bottom: 1PX solid #f3f3f3 !important; }\n\n.pl_list_d img {\n  width: 3.8rem;\n  border-radius: 50%; }\n\n.pl_list_d .middle p {\n  font-size: 1.5rem; }\n\n.user_info_top {\n  text-align: left;\n  margin-left: 10px; }\n\n.user_info_top div {\n  display: inline-block; }\n\n.user_info_top .name {\n  font-size: 1.5rem; }\n\n.pl_list_d_f {\n  margin-top: 10px; }\n\n.middle p {\n  color: #555555; }\n\n.user_info_top .pj {\n  margin-left: 5px; }\n\n.info_select ion-icon {\n  font-size: 1.6rem; }\n\n.jianjie_ {\n  padding: 0px 15px; }\n\n.jianjie_ .list {\n  color: #333333;\n  font-size: 1.5rem;\n  margin: 0.8rem 0rem; }\n\n.jianjie_ .list .val {\n  color: #666666;\n  font-size: 1.5rem; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _dataservice_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../dataservice.service */ "./src/app/dataservice.service.ts");
/* harmony import */ var _ionic_native_wechat_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic-native/wechat/ngx */ "./node_modules/@ionic-native/wechat/ngx/index.js");
...
var ConsultantPage = /** @class */ (function () {
    function ConsultantPage(navCtrl, ClipboardService, Wechat, ActivatedRoute, DataserviceService, router, location, appmin, alertCtrl, toastCtrl, modctrl, modalCtrl, loadingCtrl, storage) {
        //加载缓存数据 
        ...
        this.currentStyles = { 'background-color': ' rgba(255, 255, 255, 0)', 'padding-top': '2rem', 'border-bottom': '1px solid rgb(238, 238, 238,0)' };
        ...
        if (this.appmin.GetPhoneMode() != "ios") {
            this.header_class = "c_header_class";
        }
        else {
    ...
    ConsultantPage.prototype.setPjimg = function (e, count) {
        if (count == 1) {
            jquery__WEBPACK_IMPORTED_MODULE_10__(e).attr("src", "assets/img/xing1.png");
            return "assets/img/xing1.png";
        }
        else {
            jquery__WEBPACK_IMPORTED_MODULE_10__(e).attr("src", "assets/img/xing.png");
    ...
    ConsultantPage.prototype.service_select = function (obj, objid) {
        //服务列表单击事件
        jquery__WEBPACK_IMPORTED_MODULE_10__('.listobj_f .serviceF').removeClass('serviceF_select');
        jquery__WEBPACK_IMPORTED_MODULE_10__(obj).closest('.serviceF').addClass('serviceF_select');
        // alert("objid="+objid)
    ...
    ConsultantPage.prototype.dataHandle = function (meg, isShow) {
        ...
        if (meg['type'] == 'ret_setUpFollow') {
            if (this.isFollow) {
                //已经关注
                this.isFollow = false;
                this.show_toastCtrl("取消关注");
            }
            else {
                this.isFollow = true;
                this.show_toastCtrl("关注成功");
            }
        }
    ...
    ConsultantPage = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavController"], ngx_clipboard__WEBPACK_IMPORTED_MODULE_9__["ClipboardService"], _ionic_native_wechat_ngx__WEBPACK_IMPORTED_MODULE_8__["Wechat"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"], _dataservice_service__WEBPACK_IMPORTED_MODULE_7__["DataserviceService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["Location"], _core__WEBPACK_IMPORTED_MODULE_2__["AppMin"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ToastController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["LoadingController"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"]])
    ], ConsultantPage);
