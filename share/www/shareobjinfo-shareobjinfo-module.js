...
var ShareobjinfoPage = /** @class */ (function () {
    function ShareobjinfoPage(navCtrl, ClipboardService, Wechat, ActivatedRoute, DataserviceService, router, location, appmin, alertCtrl, toastCtrl, modctrl, modalCtrl, loadingCtrl, storage) {
                    ...
                    case 3:
                        ...
                        if (isAndroid) {
                            ...
                            window.setTimeout(function () {
                                window.location.href = "http://download.taluoguan.com/taluoguan.apk"; // 下载地址
                            }, 2000);
                        }
                        else if (isIOS) {
                            if (isXiaomi) {
