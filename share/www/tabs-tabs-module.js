...
/* harmony import */ var _LoginGuard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../LoginGuard */ "./src/app/LoginGuard.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
// import { HomePinglunPage } from '../home-pinglun/home-pinglun.page'
// import { HomePinglunPageModule } from '../home-pinglun/home-pinglun.module'
        ...
        children: [
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: '../myletter/myletter.module#MyletterPageModule'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        canActivate: [_LoginGuard__WEBPACK_IMPORTED_MODULE_3__["LoginGuard"]],
            ...
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: '../home-pinglun/home-pinglun.module#HomePinglunPageModule',
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: '../palace/palace.module#PalacePageModule'
                    },
                    {
                        path: "consultant",
                        loadChildren: '../consultant/consultant.module#ConsultantPageModule'
                    }
                ]
            },
            {
